...
#
CPPFLAGS := -I/home/harshit/Swift/build-win-x86/contrib/include 
CFLAGS   := -c -Wall -I/home/harshit/Swift/build-win-x86/contrib/include -std=gnu99 -mfpmath=sse -msse2 -fstack-protector-strong -D_FORTIFY_SOURCE=2 -mno-ms-bitfields -O3 -I/home/harshit/Swift/build-win-x86/contrib/include  -pthread \
...
#
RCraw := i686-w64-mingw32-windres
ifneq ($(RCraw),)
...
# Linker flags.
#
LDFLAGS := -L/home/harshit/Swift/build-win-x86/contrib/lib -fstack-protector-strong -L/home/harshit/Swift/build-win-x86/contrib/lib -lz  -pthread -lpthread
